...
\begin{document}
	...
	We decided to use Germany as an example for modeling epidemics.These values were actual on April 5, 2020. And we take into account further statistics to fine tune the parameters to real life.

	\subsection{Obtained result}
	placeholder

	\subsection{Comparing with real life situation}
	placeholder
